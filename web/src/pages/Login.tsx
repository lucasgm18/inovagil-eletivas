...
function Login() {
  ...
  return (
    <div className="bg-slate-900 flex-col flex items-center justify-start flex-1 min-h-screen text-zinc-50">
      <img src={Logo} className="size-56" alt="" />
      <div className="flex w-full items-center flex-col justify-center text-center space-y-2 mb-12">
      ...
      <div className="w-[90%]">
        <form
          ...
          className="bg-zinc-800 w-full flex items-center justify-center flex-col space-y-8 py-8 rounded"
        >
